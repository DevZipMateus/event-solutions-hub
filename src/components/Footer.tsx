...
const Footer = () => {
  return (
    <footer className="bg-primary py-12 md:py-16 overflow-hidden">
          ...
          <div className="md:text-right">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 md:justify-end">
                <MapPin className="w-5 h-5 text-white mt-1 flex-shrink-0 md:order-2" />
                <address className="text-white/80 not-italic md:text-right">
              ...
              <div className="flex items-center gap-3 md:justify-end">
                <Mail className="w-5 h-5 text-white flex-shrink-0 md:order-2" />
                <a
              ...
              <div className="flex items-center gap-3 md:justify-end">
                <Phone className="w-5 h-5 text-white flex-shrink-0 md:order-2" />
                <a
